...
from quickstart.api_views import GalaxyViewSet, StarSystemViewSet, StarViewSet, PlanetViewSet, MoonViewSet
...
# router.register(r'Moon', MoonViewSet) опишешь потом view set
